...
const version = '1.0.3'; // GitHub Release tag (mcp-v1.0.3)
...
const binaryName = `correctover-mcp-${osName}-${archName}${platform === 'win32' ? '.exe' : ''}`;
const url = `https://github.com/${repo}/releases/download/mcp-v${version}/${binaryName}`;
